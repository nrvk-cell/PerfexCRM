...
# Settings
$lang['settings_rtl_support_admin']                                   = 'RTL Area Admin (Da Destra a Sinistra)';
...
$lang['show_proposals_on_calendar']                       = 'Proposte';
...
$lang['failed_to_copy_task']                    = 'La copia del compito è fallita';
...
$lang['tax_is_used_in_expenses_warning']        = 'Non puoi aggiornare questa tassa poiché sono state trovate transazioni di spesa che già la utilizzano.';
$lang['note']                                   = 'Nota';
...
$lang['do_not_redirect_payment']                = 'Non reindirizzarmi all\'elaboratore pagamenti';
...
$lang['customer_admins']                        = 'Admin Cliente';
...
$lang['not_lead_activity_created_proposal']      = 'Nuova proposta creata - %s';
...
$lang['cf_option_in_use']                                   = 'Un\'opzione che hai rimosso è in uso e non può essere rimossa. L\'opzione viene automaticamente aggiunta alle opzioni esistenti.';
...
# Version 2.2.1
$lang['customer_files_info_message'] = 'I file di progetti e attività collegati al cliente non sono visualizzati in questa tabella.';
$lang['ticket_import_reply_only']    = 'Prova ad importare solo la risposta effettiva al ticket (senza messaggio citato/inoltrato)';
$lang['learn_more']                  = 'Scopri di più';
...
$lang['module_by']                               = 'Di %s';
$lang['staff_which_are_using_role']              = 'Membri del personale che utilizzano questo ruolo';
$lang['copy']                                    = 'Copia';
$lang['read_more']                               = 'Leggi Altro';
$lang['show_less']                               = 'Mostra meno';
$lang['project_progress_text']                   = 'Avanzamento Progetto';
$lang['timer_not_stopped_yet']                   = 'Questo timer non è ancora stato fermato';
...
# Version 2.3.2
$lang['create_recurring_from_child_error_message'] = 'Non puoi impostare questo %s come ricorrente perché questo %s è un figlio di un altro %s ricorrente.';
$lang['statement_credit_note_refund']              = 'Rimborso Nota di Credito - %s';
$lang['no_validation']                             = 'Nessuna Validazione';
$lang['lead_unique_validation_on']                 = 'Esegui la validazione per i potenziali clienti duplicati sui seguenti campi:';
$lang['phonenumber_exists']                        = 'Il numero di telefono esiste già';
$lang['company_exists']                            = 'L\'azienda esiste già';
$lang['website_exists']                            = 'Il sito web esiste già';
$lang['send_payment_receipt_to_client']            = 'Invia la ricevuta di pagamento al cliente';
$lang['payment_sent_successfully']                 = 'Ricevuta di pagamento inviata con successo.';
$lang['payment_sent_failed']                       = 'Invio della ricevuta di pagamento fallito.';

# Version 2.3.5
$lang['tags_update_replace_warning'] = 'Alcuni tag non vengono aggiornati perché il nome del tag esiste già';
$lang['attach_statement']            = 'Allega Dichiarazione Cliente';

# Version 2.4.0
$lang['delete_credit_card']                        = 'Elimina Carta';
$lang['delete_credit_card_info']                   = 'Non puoi eliminare la carta di credito perché hai abbonamenti attivi.';
$lang['credit_card_successfully_deleted']          = 'Carta di credito eliminata con successo.';
$lang['subscription_incomplete']                   = 'Incompleto';
$lang['subscription_incomplete_expired']           = 'Incompleto Scaduto';
$lang['credit_card_short']                         = 'Carta';
$lang['webhook_created']                           = 'Webhook creato con successo.';
$lang['subscriptions_terms_info']                  = 'Inserisci termini e condizioni per il cliente da mostrare prima di sottoscrivere l\'abbonamento.';
$lang['subscription_complete_payment']             = 'Completa Pagamento';
$lang['subscription_is_subscription_is_expired']   = 'Questo abbonamento è scaduto.';
$lang['subscription_plan_currency_does_not_match'] = 'La valuta del piano selezionato non corrisponde alla valuta selezionata di seguito.';
$lang['subscription_first_billing_date_info']      = 'Lascia vuoto per usare la data in cui il cliente si abbona. Questo campo deve contenere una data futura. Se selezioni una data passata e il cliente non è ancora abbonato, verrà usata la data di sottoscrizione effettiva.';
$lang['stripe_subscription_select_plan']           = 'Seleziona piano Stripe';

# Version 2.4.1
$lang['contract_content_permission_edit_warning'] = 'Le tue attuali autorizzazioni non ti permettono di modificare il contenuto del contratto. Consulta un amministratore per ottenere il permesso di modificare i contratti.';
$lang['mark_as_signed']                 = 'Segna come firmato';
$lang['unmark_as_signed']               = 'Rimuovi il segno di firmato';
$lang['marked_as_signed']               = 'Segnato come firmato';
$lang['contract_marked_as_signed_info'] = 'Questo contratto è stato contrassegnato manualmente come firmato.';
$lang['save_and_send_later']            = 'Salva e invia più tardi';
$lang['schedule']                       = 'Pianifica';
$lang['schedule_email_for']             = 'Pianifica l\'invio dell\'email per %s';
$lang['schedule_date']                  = 'Quando vuoi inviare l\'email?';
$lang['email_scheduled_successfully']   = 'Email pianificata con successo';
$lang['invoice_will_be_sent_at']        = 'La fattura sarà inviata alle %s';

# Version 2.5.0
$lang['recaptcha_ignore_ips']            = 'Indirizzi IP ignorati';
$lang['recaptcha_ignore_ips_info']       = 'Inserisci gli indirizzi IP separati da virgole per cui vuoi saltare la validazione reCaptcha.';
...
$lang['lead_value']                      = 'Valore del lead';
$lang['lead_value_tooltip']              = 'Verrà utilizzata la valuta base.';
$lang['leads_dt_lead_value']             = 'Valore del lead';
$lang['leads_canban_lead_value']         = 'Valore del lead: %s';
$lang['lead_add_edit_lead_value']        = 'Valore del lead';
...
# Version 2.7.0
$lang['hour_of_day_perform_tasks_reminder_notification_help'] = 'Formato 24 ore, ad es. 9 per le 9:00 o 15 per le 15:00. Usato per attività ricorrenti, promemoria attività, ecc.';
$lang['clients_nav_contacts']                                 = 'Contatti';
$lang['clients_my_contacts']                                  = 'I miei contatti';
$lang['clients_my_contact']                                   = 'Contatto';
$lang['new_contact']                                          = 'Nuovo contatto';
...
$lang['allow_primary_contact_to_manage_other_contacts']       = 'Permetti al contatto principale di gestire altri contatti del cliente';
$lang['contact_form_validation_is_unique']                    = 'Un contatto con questo {field} esiste già nel nostro sistema';
$lang['invoice_number_not_applied_on_draft']                  = 'Se la fattura viene salvata come bozza, il numero non verrà applicato. Il numero successivo verrà assegnato quando la fattura verrà inviata al cliente o contrassegnata come inviata.';
...
$lang['set_google_two_factor_authentication_failed'] = 'Errore nel salvataggio dell\'autenticazione, riprova';
$lang['enter_two_factor_auth_code_from_mobile']      = 'Inserisci il codice di autenticazione dall\'app Authenticator';
...
$lang['set_two_factor_authentication_successful']    = 'Impostazioni di autenticazione a due fattori aggiornate con successo';
$lang['set_two_factor_authentication_failed']        = 'Impossibile aggiornare le impostazioni di autenticazione a due fattori';
$lang['google_2fa_code_valid']                       = 'Autenticazione verificata con successo';
$lang['google_2fa_code_invalid']                     = 'Codice di autenticazione non valido, riprova.';
$lang['google_2fa_scan_qr_guide']                    = 'Scansiona il QR qui sotto con l\'app Google Authenticator sul tuo dispositivo mobile, quindi inserisci il codice generato nell\'app nel campo sottostante';
$lang['google_2fa_manul_input_secret']               = 'Chiave segreta per input manuale';

# Version 2.7.1
$lang['templates']                                   = 'Modelli';
$lang['add_template']                                = 'Aggiungi modello';
$lang['edit_template']                               = 'Modifica modello';
$lang['template_added']                              = 'Modello aggiunto con successo';
$lang['template_updated']                            = 'Modello aggiornato con successo';
$lang['template_name']                               = 'Titolo del modello';
$lang['template_content']                            = 'Contenuto del modello';
$lang['insert_template']                             = 'Inserisci';
$lang['items_table_amounts_exclude_currency_symbol'] = 'Escludi il simbolo della valuta dalla tabella importi';

$lang['multiplies_of']               = 'Multipli di';
$lang['round_off_task_timer_option'] = 'Arrotonda il timer dell\'attività';
...
$lang['two_checkout_payment_processing'] = 'Il pagamento è in fase di elaborazione, verrai notificato in caso di successo';
$lang['two_checkout_payment_cancelled']  = 'Pagamento annullato';
$lang['two_checkout_merchant_code']      = 'Codice commerciante';
$lang['two_checkout_secret_Key']         = 'Chiave segreta';
$lang['two_gateway_webhook_notice']      = 'L\'endpoint IPN per 2Checkout è ( %s )';
$lang['something_went_wrong']            = 'Qualcosa è andato storto. Riprova';
$lang['imap_folder']                     = 'Cartella';
$lang['retrieve_folders']                = 'Recupera cartelle';
$lang['email_to_ticket_config']          = 'Configurazione email per ticket';


# Version 2.8.0
$lang['enable_support_menu_badges']              = 'Abilita badge nel menu supporto';
$lang['item_copy_success']                       = 'Elemento copiato con successo';
$lang['item_copy_fail']                          = 'Copia dell\'elemento non riuscita';
$lang['attach_invoice_to_payment_receipt_email'] = 'Allega la fattura in PDF quando invii la ricevuta di pagamento via email';

$lang['estimate_request']                                  = 'Richiesta preventivo';
$lang['estimate_requests']                                 = 'Richieste preventivo';
$lang['estimate_request_form']                             = 'Modulo richiesta preventivo';
$lang['acs_estimate_request']                              = 'Richieste preventivo';
$lang['acs_estimate_request_forms']                        = 'Moduli richieste preventivo';
$lang['estimate_request_forms']                            = 'Modulo richieste preventivo';
...
$lang['estimate_request_status']                           = 'Stati richiesta';
$lang['estimate_request_date_added']                       = 'Data di creazione';
$lang['estmate_request_tags_updated']                      = 'Tag aggiornati';
$lang['not_estimate_request_activity_status_updated']      = 'Stato della richiesta aggiornato da %s a %s';
$lang['estimate_request_lowercase']                        = 'richiesta preventivo';
$lang['estimate_request_form_email_field_is_required']     = 'Il campo email è obbligatorio per creare il modulo';
$lang['estimate_request_form_email_field_set_to_required'] = 'Imposta il campo email come obbligatorio';
$lang['not_delete_estimate_request_default_status']        = 'Impossibile eliminare lo stato predefinito della richiesta';
...
$lang['estimate_request_client_firstname']                 = 'Nome cliente';
$lang['estimate_request_client_lastname']                  = 'Cognome cliente';
...
$lang['estimate_request_status_lowercase']                 = 'stato richiesta preventivo';
$lang['estimate_request_assigned_to_staff']                = 'Richiesta assegnata';

$lang['activity_due_reminder_is_sent']   = 'Promemoria di scadenza inviato per la fattura %s';
$lang['invoice_due_notice_before']       = 'Invia promemoria di scadenza X giorni prima della data di scadenza';
$lang['overdue_notices']                 = 'Avvisi di ritardo';
$lang['invoice_overdue_notices_info']    = 'Gli avvisi di ritardo vengono inviati quando la fattura diventa scaduta.';
$lang['due_reminders']                   = 'Promemoria scadenza';
$lang['due_reminders_for_invoices_info'] = 'I promemoria di scadenza vengono inviati per fatture non pagate o parzialmente pagate come promemoria al cliente di pagare prima della scadenza.';
$lang['expenses_list_made_payment_by']   = 'Pagamento effettuato da %s';

# Version 2.8.2
$lang['hide_task_checklist_items_completed'] = 'Nascondi elementi completati';
$lang['show_task_checklist_items_completed'] = 'Mostra elementi completati %s';
$lang['task_checklist_assign']               = 'Assegna membro staff';
$lang['task_checklist_assigned']             = 'Assegnato a %s';

# Version 2.8.3
$lang['projects_send_contact_notification']                   = 'Invia notifiche ai contatti';
$lang['project_send_all_contacts_with_notifications_enabled'] = 'A tutti i contatti con notifiche abilitate per i progetti';
$lang['project_do_not_send_contacts_notifications']           = 'Non inviare notifiche';
$lang['project_send_specific_contacts_with_notification']     = 'Contatti specifici';
$lang['project_contacts_to_notify']                           = 'Seleziona i contatti da notificare';
$lang['contract_signed_by']                                   = 'Nome firmatario';
$lang['contract_signed_date']                                 = 'Data firma';
$lang['contract_signed_ip']                                   = 'Indirizzo IP';
$lang['show_estimate_request_in_customers_area']              = 'Mostrare il link richiesta preventivo nell\'area clienti?';
$lang['customers_estimate_request_link_text']                 = 'Richiedi un preventivo';
$lang['total_expenses_deleted']                               = 'Totale spese eliminate: %s';
$lang['estimate_convert_to_project']                          = 'Converti in progetto';
$lang['estimate_items_convert_to_tasks']                      = 'Elementi che verranno convertiti in attività';

# Version 2.9.0
$lang['home_payment_records']                                  = 'Registri di pagamento';
$lang['weekly']                                                = 'Settimanale';
$lang['monthly']                                               = 'Mensile';
$lang['failed_to_update_timesheet']                            = 'Impossibile aggiornare il foglio ore';
$lang['permission_create_timesheets']                          = 'Crea fogli ore';
$lang['permission_edit_timesheets']                            = 'Modifica fogli ore (globale)';
$lang['permission_edit_own_timesheets']                        = 'Modifica propri fogli ore';
$lang['permission_delete_timesheets']                          = 'Elimina fogli ore (globale)';
$lang['permission_delete_own_timesheets']                      = 'Elimina propri fogli ore';
$lang['permission_edit_milestones']                            = 'Modifica milestone';
$lang['permission_delete_milestones']                          = 'Elimina milestone';
$lang['add_timesheet']                                         = 'Aggiungi foglio ore';
$lang['submit_button_bg_color']                                = 'Colore sfondo pulsante di invio';
$lang['submit_button_text_color']                              = 'Colore testo pulsante di invio';
$lang['automatically_assign_ticket_to_first_staff_responding'] = 'Assegna automaticamente il ticket al primo membro staff che risponde?';

# Version 2.9.1
$lang['contract_signed_not_all_fields_editable'] = 'Questo contratto è firmato, quindi non tutti i campi possono essere modificati finché la firma non viene rimossa.';
$lang['form_submit_success_action']              = 'Cosa deve succedere dopo l\'invio di questo modulo?';
$lang['form_submit_success_display_thank_you']   = 'Mostra un messaggio di ringraziamento';
$lang['form_submit_success_redirect_to_website'] = 'Reindirizza a un altro sito web';
$lang['form_submit_website_url']                 = 'URL del sito web';

# Version 2.9.2
$lang['open_google_map']                                  = 'Apri in Google Maps';
$lang['milestone_start_date']                             = 'Data inizio';
$lang['send_reminder_for_completed_but_not_billed_tasks'] = 'Invia un promemoria via email per attività fatturabili completate ma non fatturate';
$lang['staff_to_notify_completed_but_not_billed_tasks']   = 'Seleziona il personale che deve ricevere il promemoria';
$lang['reminder_for_completed_but_not_billed_tasks_days'] = 'Seleziona i giorni della settimana in cui inviare il promemoria';
$lang['notifications']                                    = 'Notifiche';
$lang['merged']                                           = 'Unito';
$lang['ticket_merged_notice']                             = 'Questo ticket è stato unito al ticket con ID';
$lang['view_primary_ticket']                              = 'Visualizza ticket principale';
$lang['merge_tickets']                                    = 'Unisci ticket';
$lang['primary_ticket']                                   = 'Ticket principale';
$lang['primary_ticket_status']                            = 'Stato ticket principale';
$lang['tickets_merged']                                   = 'Ticket uniti con successo';
$lang['cannot_merge_into_merged_ticket']                  = 'Un ticket già unito a un altro non può essere usato come ticket principale';
$lang['merge_ticket_ids_field_label']                     = 'Unisci Ticket #';
$lang['merge_ticket_ids_field_placeholder']               = 'esempio: 5 o 5,6';
$lang['cannot_merge_tickets_with_ids']                    = 'Il ticket %s è già stato unito a un altro ticket';
$lang['ticket_merged_tickets_header']                     = 'Questo ticket contiene %s ticket uniti';
$lang['batch_payments_table_invoice_number_heading']      = 'Numero fattura';
$lang['batch_payments_table_payment_date_heading']        = 'Data pagamento';
$lang['batch_payments_table_payment_mode_heading']        = 'Metodo di pagamento';
$lang['batch_payments_table_transaction_id_heading']      = 'ID transazione';
$lang['batch_payments_table_amount_received_heading']     = 'Importo ricevuto';
$lang['batch_payments_table_invoice_balance_due']         = 'Saldo fattura dovuto';
$lang['add_batch_payments']                               = 'Aggiungi pagamenti';
$lang['batch_payment_filter_by_customer']                 = 'Filtra fatture per cliente';
$lang['batch_payments']                                   = 'Pagamenti in blocco';
$lang['batch_payment_added_successfully']                 = 'Hai aggiunto con successo %s pagamenti';
$lang['batch_payments_send_invoice_payment_recorded']     = 'Non inviare email di registrazione pagamento fattura ai contatti del cliente';
$lang['invoice_batch_payments']                           = 'Pagamento in blocco';
$lang['staff_is_currently_replying']                      = '%s sta attualmente rispondendo al ticket.';

# Version 2.9.4
$lang['permission_view_timesheet_report']                  = 'Visualizza report fogli ore';
$lang['timesheets_overview_all_members_notice_permission'] = 'La panoramica dei fogli ore di tutti i membri del personale è disponibile solo per il personale con il permesso di visualizzare i report dei fogli ore e per gli amministratori.';
$lang['show_project_on_proposal']                          = 'Mostra nome progetto sulla proposta';
$lang['ticket_reports_staff']                              = 'Membro dello staff';
$lang['ticket_reports_total_assigned']                     = 'Ticket assegnati totali';
...
$lang['home_tickets_report']                               = 'Report ticket dello staff';
$lang['ticket_reports_average_reply_time_help']            = 'Tempo medio di risposta ai ticket assegnati.';
$lang['created_by']                                        = 'Creato da';

$lang['staff_related_ticket_notification_to_assignee_only']      = 'Invia notifiche relative ai ticket solo all\'assegnatario';
$lang['staff_related_ticket_notification_to_assignee_only_help'] = 'Se impostato su Sì e il ticket non ha un assegnatario, la notifica verrà inviata a tutti i membri dello staff appartenenti al dipartimento del ticket';
$lang['import_expenses']                                         = 'Importa spese';
$lang['show_pdf_signature_proposal']                             = 'Mostra firma PDF sulla proposta';
$lang['enable_honeypot_spam_validation']                         = 'Abilita validazione spam Honeypot';

# Version 3.0.0
$lang['contracts_view_marked_as_signed'] = 'Contrassegnato come firmato';
...
$lang['search_estimates']                = 'Cerca preventivi';
$lang['quick_create']                    = 'Creazione rapida';

# Version 3.0.5
$lang['subscription_last_sent']                             = 'Ultimo invio';
$lang['automatically_set_logged_in_staff_sales_agent']      = 'Assegna automaticamente il membro staff loggato come agente di vendita';
$lang['automatically_set_logged_in_staff_sales_agent_help'] = 'Applicabile a: Preventivi, fatture, proposte';
$lang['permission_view_all_templates']                      = 'Visualizza tutti i modelli';
$lang['settings_contract_sign_reminder_every_days_info']    = 'I promemoria di firma vengono inviati ai contatti del cliente dopo il primo invio del contratto. Vengono automaticamente interrotti quando il contratto è firmato.';
$lang['contract_sign_reminder_every_days']                  = 'Invia promemoria firma ogni (giorni)';
$lang['contract_sign_reminders']                            = 'Promemoria firma';
$lang['payment_gateway_fee_percentage']                     = 'Commissione in percentuale';
$lang['payment_gateway_fee_fixed']                          = 'Commissione fissa';
$lang['payment_attempt_amount']                             = 'Totale fattura';
$lang['payment_attempt_fee']                                = 'Commissione di pagamento';
$lang['feature']                                            = 'Caratteristica';
$lang['capabilities']                                       = 'Capacità';

# Version 3.1.0
$lang['filter_boolean_yes'] = 'Sì';
$lang['filter_boolean_no'] = 'No';
$lang['filter_matchtype_and'] = 'e';
$lang['filter_matchtype_or'] = 'o';
$lang['filter_share'] = 'Condividere con altri membri del team?';
$lang['filter_mark_as_default'] = 'Imposta come predefinito';
$lang['filter_unmark_as_default'] = 'Rimuovi come predefinito';
$lang['filter_save'] = 'Salva filtro';
$lang['filter_name'] = 'Nome filtro';
$lang['filter_apply'] = 'Applica';
$lang['filter_apply_and_save'] = 'Applica e salva';
$lang['filter_use_dynamic_dates'] = 'Usa date dinamiche';
$lang['filter_new'] = 'Nuovo filtro';
$lang['filter_clear_active'] = 'Cancella filtro attivo';
$lang['filter_edit'] = 'Modifica';
$lang['filter_create'] = 'Crea filtro';
$lang['filter_update'] = 'Aggiorna filtro';
$lang['filter_delete'] = 'Elimina filtro';
$lang['filter_cannot_be_shared'] = 'Questo filtro non può essere condiviso con altri membri del team poiché contiene regole che potrebbero non essere disponibili per tutti gli utenti.';
$lang['filter_add_rule'] = 'Aggiungi regola';

$lang['filter_operator_is_empty'] = 'è vuoto';
$lang['filter_operator_is_not_empty'] = 'non è vuoto';
$lang['filter_operator_equal'] = 'uguale a';
$lang['filter_operator_not_equal'] = 'diverso da';
$lang['filter_operator_begins_with'] = 'inizia con';
$lang['filter_operator_not_begins_with'] = 'non inizia con';
$lang['filter_operator_contains'] = 'contiene';
$lang['filter_operator_not_contains'] = 'non contiene';
$lang['filter_operator_ends_with'] = 'termina con';
$lang['filter_operator_not_ends_with'] = 'non termina con';
$lang['filter_operator_in'] = 'è in';
$lang['filter_operator_not_in'] = 'non è in';
$lang['filter_operator_between'] = 'tra';
$lang['filter_operator_not_between'] = 'non tra';
$lang['filter_operator_dynamic'] = 'dinamico';
$lang['filter_operator_greater'] = 'maggiore di';
$lang['filter_operator_greater_or_equal'] = 'maggiore o uguale a';
$lang['filter_operator_less'] = 'minore di';
$lang['filter_operator_less_or_equal'] = 'minore o uguale a';
$lang['no_filters_found'] = 'Nessun filtro salvato, inizia creando un nuovo filtro.';

$lang['staff_logged_in_public_ticket_warning'] = 'Sei loggato come membro dello staff, se vuoi rispondere al ticket come staff, devi farlo dall\'area amministrativa.';

# Version 3.1.2
$lang['allow_non_admin_members_to_delete_tickets_and_replies'] = 'Consenti ai membri non amministratori di eliminare ticket e risposte';
$lang['default_filter_info'] = 'Il filtro sarà contrassegnato come predefinito solo per il tuo account.';
$lang['required_register_fields'] = 'Campi richiesti per la registrazione (area clienti)';

# Version 3.1.6
$lang['allow_non_admin_members_to_edit_ticket_messages'] = 'Consenti ai membri non amministratori di modificare i messaggi dei ticket';
$lang['proposal_auto_convert_to_invoice_on_client_accept'] = 'Converti automaticamente la proposta in fattura dopo l\'accettazione del cliente (solo per proposte relative ai clienti)';
$lang['invoice_activity_auto_converted_from_proposal'] = 'Fattura creata automaticamente dalla proposta con numero %s';
$lang['clients_proposal_invoiced_successfully'] = 'Grazie per aver accettato la proposta. Controlla la fattura creata per la proposta';

# Version 3.2.0
$lang['ideal_payment_failure_message'] = 'Il pagamento è fallito o è stato annullato.';
$lang['ideal_api_publishable_key'] = 'Chiave pubblica Stripe';
$lang['ideal_api_secret_key'] = 'Chiave API segreta Stripe';
$lang['filters'] = 'Filtri';
$lang['view_financial_stats'] = 'Visualizza statistiche finanziarie';
$lang['timesheet_summary'] = 'Riepilogo foglio ore';
$lang['timesheet_detailed_overview'] = 'Panoramica dettagliata delle ore registrate nei fogli ore';
$lang['ticket_request_history'] = 'Storico richieste';
$lang['integrations'] = 'Integrazioni';
$lang['settings_group_other'] = 'Altro';
$lang['settings_group_configure_features'] = 'Configura funzionalità';
$lang['disable_ticket_public_url'] = 'Disabilita URL pubblico per i ticket';

# Version 3.2.1
$lang['ideal_gateway_keys_not_configured'] = 'API iDEAL Payment Gateway non configurata.';
...
$lang['welcome_back_sign_in'] = 'Benvenuto, effettua l\'accesso alla tua dashboard';
